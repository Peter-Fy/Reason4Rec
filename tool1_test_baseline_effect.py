...
dataset = 'Yelp_data'
part_i = 3
data_df = pd.read_pickle(f'./dataset/{dataset}/formal_2_round_sample_answers/round1_eval.pkl')
...
for idx, row in tqdm(data_df.iterrows(), total=len(data_df)):
    ...
    data_df.at[idx, 'pred_baseline'] = pred_with_review
    data_df.to_pickle(f'./dataset/{dataset}/formal_2_round_sample_answers/round1_baseline_{part_i}.pkl')